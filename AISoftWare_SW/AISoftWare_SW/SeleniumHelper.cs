...
namespace AISoftWare_SW
{
    public class SeleniumHelper
    {
        ...
        public static void OnMainSetting()
        {
            ...
            Cookie cookie1 = new Cookie("__cf_bm", "");
            
            Cookie cookie2 = new Cookie("__Secure-next-auth.callback-url", "https%3A%2F%2Fchat.openai.com%2Fchat"); //바꿀필요X
            
            Cookie cookie3 = new Cookie("__Secure-next-auth.session-token", "");
            //세션키
            Cookie cookie4 = new Cookie("cf_clearance", ""); //2개중 아래가 이부분이 캡챠임

            Cookie cookie5 = new Cookie("__Host-next-auth.csrf-token", ""); //2개중 아래가 이부분이 캡챠임
